...
app.get('/', function (req, res) {      // The first route
    res.render('index', {pretty:true, x : x, y : y, result : x + y}); // Render the 'index' view in 'pretty' mode - the resulting HTML code will be indented - the 'pretty' option has the 'deprecated' status - in the future it will not be supported
